...
public class AlignToTowerLeft extends Command {
  ...
  private Pose2d redTowerLeftPose = new Pose2d(15.25,3.48,new Rotation2d(0));
  private Pose2d blueTowerLeftPose = new Pose2d(1.27,4.83,new Rotation2d(Math.toRadians(180)));
