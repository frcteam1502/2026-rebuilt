...
public class DriverCommands extends Command {
  ...
  private SlewRateLimiter forwardLimiter = new SlewRateLimiter(DrivebaseCfg.FORWARD_SLEW_RATE);
  private SlewRateLimiter strafeLimiter = new SlewRateLimiter(DrivebaseCfg.STRAFE_SLEW_RATE);
